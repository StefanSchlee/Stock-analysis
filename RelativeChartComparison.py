...
#get chart
chartHistory1 = ticker1.history(period='5y',interval='1d',adj_timezone=False)['close'][symbol1]
chartHistory1.index = pd.DatetimeIndex(chartHistory1.index).tz_localize(None)
chartHistory2 = ticker2.history(period='5y',interval='1d',adj_timezone=False)['close'][symbol2]
chartHistory2.index = pd.DatetimeIndex(chartHistory2.index).tz_localize(None)


#calculate relative chart
relChartHistory1 = pd.Series(chartHistory1.array/chartHistory1.array[0]*100,chartHistory1.index) 
relChartHistory2 = pd.Series(chartHistory2.array/chartHistory2.array[0]*100,chartHistory2.index) 
